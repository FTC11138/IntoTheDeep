...
public class MecanumDrive extends com.acmerobotics.roadrunner.drive.MecanumDrive {
    ...
    public void initializeRoadrunner(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, config.leftFront);
        leftRear = hardwareMap.get(DcMotorEx.class, config.leftRear);
        rightRear = hardwareMap.get(DcMotorEx.class, config.rightRear);
        rightFront = hardwareMap.get(DcMotorEx.class, config.rightFront);
